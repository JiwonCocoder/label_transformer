...
class SSLTrainer(Trainer):
    ...
    def init_dataloader(self):
        ...
        #dest = <class 'dataloader.cifar.Cifar10SSL'>
        ...
        #K: Tagg or Tsimple을 해주는 data 갯수
        ...
        '''
        dtrain_lab, dtrain_unlab : Cifar10 (depending on dataset ) but Dset has no __len__/__getitem__ 
        따라서 SSLataLoader calling iter - Cifar10SSL - CifarSSL - SSLDataset 
        '''
